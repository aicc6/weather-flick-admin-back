...
async def get_dashboard_summary(
    ...
    try:
        ...
        summary = {
            ...
            "system": {
                "status": full_stats.get("system", {}).get("database_status", "unknown"),
                "weather_data_count": full_stats.get("system", {}).get("weather_data_count", 0)
            },
            "activities": {
                "today_count": full_stats.get("activities", {}).get("today_activities", 0),
