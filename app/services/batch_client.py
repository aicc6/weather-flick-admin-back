...
from app.schemas.batch import (
    BatchJobType, BatchJobStatus, BatchJobExecuteRequest,
    BatchJobResponse, BatchJobListResponse, BatchJobStatusResponse,
    BatchJobLogResponse, BatchJobStatisticsResponse
)
...
class BatchAPIClient:
    ...
    async def stop_job(self, job_id: str, reason: Optional[str] = None) -> Dict[str, Any]:
        """작업 중단"""
        try:
            request_data = {
                "reason": reason,
